...
export const QuantumDataInputCard = () => {
  return (
    <HolographicCard className="w-80 h-64" animationClass="animate-float">
      <div className="oracle-card p-5 h-full flex flex-col justify-between">
...
export const QuantumPreprocessorCard = () => {
  return (
    <HolographicCard className="w-80 h-64" animationClass="animate-float-2">
      <div className="oracle-card p-5 h-full flex flex-col justify-between">
        <div className="flex items-center mb-4">
...
export const QuantumAnalyticsCard = () => {
  return (
    <HolographicCard className="w-80 h-64" animationClass="animate-float-3">
      <div className="oracle-card p-5 h-full flex flex-col justify-between">
        <div className="flex items-center mb-4">
...
export const QuantumInterfaceCard = () => {
  ...
  return (
    <HolographicCard className="w-80 h-64" animationClass="animate-float-4">
      <div className="oracle-card p-5 h-full flex flex-col justify-between">
        <div className="flex items-center mb-4">
        ...
        <div className="space-y-2 flex-1">
          <div>
            <input 
              ...
              className="w-full bg-slate-800/50 border border-slate-600 rounded px-2 py-1 text-xs font-mono text-slate-200 focus:border-deepcal-light focus:outline-none" 
        ...
        <button 
          ...
          className="w-full bg-gradient-to-r from-deepcal-purple to-deepcal-light hover:from-deepcal-dark hover:to-deepcal-purple text-white py-2 px-3 rounded text-xs font-bold transition-all duration-300 transform hover:scale-[1.01] active:scale-95 flex items-center justify-center glowing-border"
        >
