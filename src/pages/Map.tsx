    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 py-8">
        <div className="container mx-auto px-4">
          <div className="mb-8">
            <h1 className="text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-deepcal-purple to-deepcal-light mb-2">
              Global Shipment Tracking
            </h1>
            <p className="text-slate-400">
              Real-time visualization of emergency logistics operations with weather intelligence
            </p>
          </div>
              ...
              <Card className="oracle-card">
                <CardHeader>
                  <div className="flex justify-between items-center">
                    <CardTitle className="text-deepcal-light">Interactive Map</CardTitle>
                ...
                <CardContent>
                  <div 
                    ref={mapContainer} 
                    className="w-full h-[600px] rounded-lg border border-deepcal-purple/20"
                  />
                </CardContent>
              </Card>
            </div>
            ...
            <div className="space-y-6">
              <Tabs value={activeTab} onValueChange={setActiveTab}>
                          ...
                          <div 
                            ...
                            className={`p-3 rounded-lg border cursor-pointer transition-all ${
                              selectedLocation?.id === location.id 
                                ...
                                : 'border-slate-600 hover:border-deepcal-purple/50'
                            }`}
                ...
                <TabsContent value="weather" className="space-y-4">
                  <Card className="oracle-card">
                    <CardHeader>
                      <CardTitle className="text-deepcal-light">Weather Conditions</CardTitle>
                    </CardHeader>
                    <CardContent>
                      <div className="space-y-3">
                        {weatherData.map((weather, index) => (
                          <div key={index} className="p-3 rounded-lg border border-slate-600">
